  ...
  function montar_calendario($mes, $ano, $conn){
    ...
    for($dia = 1; $dia <= $dias_mes; $dia++ ){
      ...
      if ( $estilo == 'class="ocupado"' ) {
        echo '<td ' . $estilo . ' align="center"><a href=marcacao.php?data='.$dia.'/'.$mes.'/'.$ano.'&marcacao="ocupado">'.$dia.'</a></td>'; 
      }else{
        echo '<td ' . $estilo . ' align="center"><a href=marcacao.php?data='.$dia.'/'.$mes.'/'.$ano.'>'.$dia . '</a></td>';
      }
...
<body>
	...
	<form action="principal-gerente.php" method="post">
